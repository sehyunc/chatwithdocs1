...
DROP TABLE "public"."nods_page_section";
...
create or replace function match_page_sections(embedding vector(1536), match_threshold float, match_count int, min_content_length int, project_id_input bigint)
